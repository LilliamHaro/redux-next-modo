  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(ProductConnected, [{
    ...
    value: function componentDidUpdate() {
      ...
      for (var i = 0; i < this.props.dataApi.length; i++) {
        if (this.props.dataApi[i].ProductCode === this.props.cc.product) {
          this.setState({
            itemName: this.props.dataApi[i].ProductName
          });
          console.log('adsfsdf');
        }
      }
...
//# sourceMappingURL=[product].js.452298b321b2b3a924b8.hot-update.js.map