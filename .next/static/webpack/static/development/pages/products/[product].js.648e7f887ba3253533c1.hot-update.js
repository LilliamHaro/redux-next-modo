...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(ProductConnected, [{
    ...
    value: function componentDidUpdate() {
      console.log('updat', this.props);

      for (var i = 0; i < this.props.dataApi.length; i++) {
        if (this.props.dataApi[i].ProductCode === this.props.cc) {
          console.log('adsfsdf');
        }

        console.log(this.props.dataApi[i].ProductCode);
...
//# sourceMappingURL=[product].js.648e7f887ba3253533c1.hot-update.js.map