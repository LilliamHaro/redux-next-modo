...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(ProductConnected, [{
    ...
    value: function componentDidMount() {
      console.log('hola desdes product');
      console.log('product props', this.props); // this.props.dataApi.map((item, i) =>
    ...
    value: function render() {
      console.log('product props render', this.props); // this.props.dataApi.map((item, i) =>
      //   item.ProductCode == this.props.cc.product ? (
      //     this.setState({
      //       itemName: item.ProductName
      //     },function(){
...
//# sourceMappingURL=[product].js.174ee8847dac9331df7e.hot-update.js.map