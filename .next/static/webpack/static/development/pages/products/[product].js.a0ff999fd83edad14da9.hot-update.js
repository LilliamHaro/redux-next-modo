...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(ProductConnected, [{
    ...
    value: function componentDidMount() {} // componentWillReceiveProps() {
    //   console.log('components will ',this.props)
    ...
    //         console.log('product',this.state.itemName)
    //       })
    //     ) : null
    //   );
    // }
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_components_layout__WEBPACK_IMPORTED_MODULE_8__["default"], {
        ...
        __self: this
      }, this.state.itemName), this.props.dataApi.map(function (item, i) {
        console.log(item);
        item.ProductCode === _this2.props.cc ? react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 59
          },
...
//# sourceMappingURL=[product].js.a0ff999fd83edad14da9.hot-update.js.map